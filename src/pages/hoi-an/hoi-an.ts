...
@Component({
  selector: 'page-hoi-an',
  templateUrl: 'hoi-an.html',
})
export class HoiAnPage {
  ...
  constructor(private domSanitizer: DomSanitizer, public navCtrl: NavController, public navParams: NavParams) {
    this.videoUrl = this.domSanitizer.bypassSecurityTrustResourceUrl('https://www.youtube.com/embed/suSXZe1Vq8Q')
  }
